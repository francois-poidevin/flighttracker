...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.flighttracker.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".flighttracker" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".flighttracker")
	}
